import { r as reactExports, j as jsxRuntimeExports, c as cn, R as React, L as Link, u as ue } from "./index-YOSDJLv_.js";
import { c as createLucideIcon, u as useComposedRefs, m as motion, B as Button } from "./proxy-C6S_XRyR.js";
import { I as Input } from "./index-BO0uOiFs.js";
import { L as Label } from "./label-BfZkcveg.js";
import { u as useLayoutEffect2, a as useControllableState, P as Primitive, c as composeEventHandlers, b as createContextScope, d as useCreatePrayerRequest, A as AnimatePresence } from "./usePrayerRequests-DL7csSQ7.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PublicLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-lg", children: [
          ...
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { className: "w-3.5 h-3.5 transition-smooth group-hover:-translate-x-0.5" }),
                  "Back to Home"
                ]
              }
            )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: submitted ? (
          /* ── Success State ── */
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.div,
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-8 h-8 text-primary" })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-2xl text-foreground", children: "Thank you — we're praying for you." }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed max-w-xs mx-auto", children: "Your prayer request has been received by our community. You are not alone." })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
            ...
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-3xl md:text-4xl text-foreground mb-2", children: "Submit a Prayer Request" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed", children: "Share what's on your heart. Every request is received with love and lifted in prayer." })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "form",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                        ...
                        isAnonymous && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Name is hidden when submitting anonymously." })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          Label,
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-4 bg-muted/50 rounded-xl px-4 py-3.5", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Your name won't be shown to anyone" })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          Switch,
                          {
