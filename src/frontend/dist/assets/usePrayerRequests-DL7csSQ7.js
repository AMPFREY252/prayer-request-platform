...
import { S as Subscribable, p as pendingThenable, i as resolveEnabled, s as shallowEqualObjects, k as resolveStaleTime, n as noop, l as environmentManager, m as isValidTimeout, t as timeUntilStale, o as timeoutManager, q as focusManager, v as fetchState, w as replaceData, x as notifyManager, y as hashKey, z as getDefaultState, r as reactExports, A as shouldThrowError, B as useQueryClient, j as jsxRuntimeExports, e as React, C as reactDomExports } from "./index-YOSDJLv_.js";
import { d as MotionConfigContext, i as isHTMLElement, e as useConstant, P as PresenceContext, f as usePresence, g as useIsomorphicLayoutEffect, L as LayoutGroupContext, h as composeRefs$1 } from "./proxy-C6S_XRyR.js";
...
function createContextScope(scopeName, createContextScopeDeps = []) {
  ...
  function createContext3(rootComponentName, defaultContext) {
    ...
    const Provider = (props) => {
      ...
      const Context = ((_a3 = scope == null ? void 0 : scope[scopeName]) == null ? void 0 : _a3[index]) || BaseContext;
      const value = reactExports.useMemo(() => context, Object.values(context));
      return /* @__PURE__ */ jsxRuntimeExports.jsx(Context.Provider, { value, children });
    };
    Provider.displayName = rootComponentName + "Provider";
...
const PrayerStatus$1 = Variant({
  "pending": Null,
  "prayed": Null
});
const Timestamp = Int;
const PrayerRequest = Record({
  "id": Nat,
  "status": PrayerStatus$1,
  "name": Opt(Text),
  "createdAt": Timestamp,
  "anonymous": Bool,
  "message": Text
...
Service({
  "createPrayerRequest": Func(
    [Opt(Text), Text, Bool],
    [Nat],
    []
  ),
  "deletePrayerRequest": Func(
    [Nat],
    [Variant({ "ok": Null, "err": Text })],
    []
  ),
  "getPrayerRequests": Func([], [Vec(PrayerRequest)], ["query"]),
  "updatePrayerRequestStatus": Func(
    [Nat, PrayerStatus$1],
    [Variant({ "ok": Null, "err": Text })],
    []
  )
...
const idlFactory = ({ IDL: IDL2 }) => {
  const PrayerStatus2 = IDL2.Variant({
    "pending": IDL2.Null,
    "prayed": IDL2.Null
  });
  const Timestamp2 = IDL2.Int;
  const PrayerRequest2 = IDL2.Record({
    "id": IDL2.Nat,
    "status": PrayerStatus2,
  ...
  return IDL2.Service({
    "createPrayerRequest": IDL2.Func(
      [IDL2.Opt(IDL2.Text), IDL2.Text, IDL2.Bool],
      [IDL2.Nat],
      []
    ),
    "deletePrayerRequest": IDL2.Func(
      [IDL2.Nat],
      [IDL2.Variant({ "ok": IDL2.Null, "err": IDL2.Text })],
      []
    ),
    "getPrayerRequests": IDL2.Func([], [IDL2.Vec(PrayerRequest2)], ["query"]),
    "updatePrayerRequestStatus": IDL2.Func(
      [IDL2.Nat, PrayerStatus2],
      [IDL2.Variant({ "ok": IDL2.Null, "err": IDL2.Text })],
      []
    )
  });
...
var PrayerStatus = /* @__PURE__ */ ((PrayerStatus2) => {
  PrayerStatus2["pending"] = "pending";
  PrayerStatus2["prayed"] = "prayed";
  return PrayerStatus2;
})(PrayerStatus || {});
class Backend {
  ...
  async createPrayerRequest(arg0, arg1, arg2) {
    if (this.processError) {
      try {
        const result = await this.actor.createPrayerRequest(to_candid_opt_n1(this._uploadFile, this._downloadFile, arg0), arg1, arg2);
        return result;
      } catch (e) {
        this.processError(e);
  ...
  async deletePrayerRequest(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.deletePrayerRequest(arg0);
  ...
  async getPrayerRequests() {
    if (this.processError) {
      try {
        const result = await this.actor.getPrayerRequests();
  ...
  async updatePrayerRequestStatus(arg0, arg1) {
    if (this.processError) {
      try {
        const result = await this.actor.updatePrayerRequestStatus(arg0, to_candid_PrayerStatus_n9(this._uploadFile, this._downloadFile, arg1));
        return from_candid_variant_n2(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
...
function from_candid_PrayerRequest_n4(_uploadFile, _downloadFile, value) {
  return from_candid_record_n5(_uploadFile, _downloadFile, value);
}
function from_candid_PrayerStatus_n6(_uploadFile, _downloadFile, value) {
...
function from_candid_record_n5(_uploadFile, _downloadFile, value) {
  return {
    id: value.id,
    status: from_candid_PrayerStatus_n6(_uploadFile, _downloadFile, value.status),
...
function from_candid_variant_n7(_uploadFile, _downloadFile, value) {
  return "pending" in value ? "pending" : "prayed" in value ? "prayed" : value;
}
function from_candid_vec_n3(_uploadFile, _downloadFile, value) {
  return value.map((x2) => from_candid_PrayerRequest_n4(_uploadFile, _downloadFile, x2));
}
function to_candid_PrayerStatus_n9(_uploadFile, _downloadFile, value) {
...
function useGetPrayerRequests() {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      return [...requests].sort((a2, b2) => Number(b2.createdAt - a2.createdAt));
    },
...
function useUpdatePrayerStatus() {
  const { actor } = useActor(createActor);
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async ({
...
function useDeletePrayerRequest() {
  const { actor } = useActor(createActor);
  const queryClient = useQueryClient();
  return useMutation({
    mutationFn: async (id) => {
...
export {
  ...
  useCreatePrayerRequest as d,
  dispatchDiscreteCustomEvent as e,
  createSlot as f,
  createContext2 as g,
  createSlottable as h,
  PrayerStatus as i,
  useGetPrayerRequests as j,
  useUpdatePrayerStatus as k,
  useDeletePrayerRequest as l,
